...
public class MessageTypeTest {
    @Test
    public void createRegistrationTypeFromString() {
    ...
    @Test
    public void createUpdateTypeFromString() {
    ...
    @Test
    public void createSuccessAnswerTypeFromString() {
    ...
    @Test
    public void createFailureAnswerTypeFromString() {
    ...
    @Test
    public void unknownStringOfMessageTypeReturnsNull() {
