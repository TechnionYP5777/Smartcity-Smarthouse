...
/** An unchecked runtime exception that will be thrown by the SensorApi if the
 * sensor was lost. We assume that the client can't handle this kind of
 * exception anyway, so we made it a runtime exception (unchecked).
 * @author RON
 * @since 07-04-2017 */
