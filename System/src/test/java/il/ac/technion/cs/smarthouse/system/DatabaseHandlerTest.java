...
public class DatabaseHandlerTest {
	...
	@Test(expected = SensorNotFoundException.class)
	public void throwsExceptionWhenGettingTableForNonExistingSensor() throws SensorNotFoundException {
	...
	@Test
	public void listenerIsCalledMultipleTimesWhenAddingMultipleEntries() throws SensorNotFoundException {
		@SuppressWarnings("unchecked")
		final Consumer<String> listener = Mockito.mock(Consumer.class);
	...
	@Test
	public void lastEntryIsNullIfThereIsNoSensor() {
