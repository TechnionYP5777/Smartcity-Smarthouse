...
public class AppInstallHelperTest {
    ...
    @BeforeClass
    public static void setup_findPackageName() {
    ...
    @Before
    public void setup_classesNames() {
    ...
    @Test
    public void testLoadBadApp_moreThanOneImplError() {
        try {
    ...
    @Test
    public void testLoadBadApp_noImplError() {
        try {
