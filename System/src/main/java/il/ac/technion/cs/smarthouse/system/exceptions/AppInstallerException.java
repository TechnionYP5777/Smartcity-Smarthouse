...
public class AppInstallerException extends Exception {
	public enum ErrorCode {
		MORE_THAN_ONE_IMPL_ERROR(0,
				"There is more than one class that extends " + SmartHouseApplication.class.getName()), NO_IMPL_ERROR(1,
						"There is no class that extends " + SmartHouseApplication.class.getName()), INSTANTIATION_ERROR(
								2,
								"Can't create an instance of the class that extends "
										+ SmartHouseApplication.class.getName()), ILLEGAL_ACCESS_ERROR(3,
