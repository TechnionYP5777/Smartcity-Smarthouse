...
public class Table<L, R> {
	...
	/**
	 * @param newCapacity
	 *            - the new capacity limit to enforce.
	 */
	...
	/**
	 * @param numOfEntries-
	 *            how many entries (from the newest to oldest) to return
	...
	/**
	 * @param row
	 *            - number of row, starts at index 0. index 0 is the OLDEST data
	 * @param col
	 *            - which column to retrieved data from
