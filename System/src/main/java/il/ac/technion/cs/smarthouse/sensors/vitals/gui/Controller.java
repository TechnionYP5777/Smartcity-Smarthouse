...
public class Controller implements Initializable {
    ...
    public void initialize(final URL location, final ResourceBundle __) {
        sensor = new VitalsSensor(Random.sensorId(), "Yarden's Vitals watch");
        ...
        pulseSlider.valueProperty().addListener((ov, oldVal, newVal) -> {
            ...
            sensor.updateSystem(pulse, (int) Math.round(bpRSlider.getHighValue()),
                            (int) Math.round(bpRSlider.getLowValue()));
            printUpdateMessage();
        });
        bpRSlider.lowValueProperty().addListener((ov, oldVal, newVal) -> {
            ...
            sensor.updateSystem((int) Math.round(pulseSlider.getValue()), (int) Math.round(bpRSlider.getHighValue()),
                            diastolicBP);
            printUpdateMessage();
        });
        ...
        bpRSlider.highValueProperty().addListener((ov, oldVal, newVal) -> {
            ...
            sensor.updateSystem((int) Math.round(pulseSlider.getValue()), systolicBP,
                            (int) Math.round(bpRSlider.getLowValue()));
            printUpdateMessage();
        });
    }
