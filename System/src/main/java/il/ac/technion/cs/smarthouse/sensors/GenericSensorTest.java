...
public class GenericSensorTest {
	private String sendPath="foo.send", recPath="foo.receive";
	...
	@Before public void init(){
		builder = new SensorBuilder()
				.setCommname("testComm")
				.setAlias("testAlias")
				.addInfoSendingPath(sendPath, String.class)
				.addInstructionsReceiveingPath(recPath);
	...
	@Test public void sendMessageSuccesfully() throws InterruptedException{
