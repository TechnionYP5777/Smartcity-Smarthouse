...
//	SIMPLE_CLOCK(ClockWidget.class, SkinType.CLOCK), 
	...
	NEEDLE_BDASHBORD(DashboardWidget.class, SkinType.CUSTOM),
...
//	private String title;
	...
	private WidgetType(final Class implClass, final SkinType skin){
		...
		skinType = skin;
//		try {
//			title = ((Class<BasicWidget>) implClass).getConstructor(WidgetType.class).newInstance(this).getTitle();
...
//		}
    ...
    public static WidgetType fromString(final String name) {
        final List<WidgetType> $ = Arrays.asList(WidgetType.values())
        								.stream()
